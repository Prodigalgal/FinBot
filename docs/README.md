...
| 目录 | 内容 | 入口 |
| --- | --- | --- |
| `requirements/` | 业务边界、验收标准和跨模块需求 | [`29-java-python-breaking-architecture.md`](./requirements/29-java-python-breaking-architecture.md) |
| `decisions/` | 已接受的架构决策与取舍 | [`012-java26-spring-data-jdbc-liquibase-python-quant.md`](./decisions/012-java26-spring-data-jdbc-liquibase-python-quant.md) |
