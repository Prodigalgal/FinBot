...
| CAP-19 | Docker、GitHub Actions、DockerHub、Argo CD、K8S | `platform` | Java API、Python quant 独立 Deployment；PostgreSQL；NetworkPolicy | 镜像签名/扫描、Secret 引用、迁移 Job、Argo Synced/Healthy、回滚演练 | Pending |
