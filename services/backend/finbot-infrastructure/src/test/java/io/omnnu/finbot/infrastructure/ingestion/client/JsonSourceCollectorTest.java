...
import io.omnnu.finbot.infrastructure.ingestion.client.JsonContentEnvelopeBuilder;
import io.omnnu.finbot.infrastructure.ingestion.client.JsonSourceCollector;
...
class JsonSourceCollectorTest {
    ...
    private static JsonSourceCollector collector(
            int port,
            io.omnnu.finbot.application.configuration.port.out.RuntimeSecretStore runtimeSecrets) {
