...
public final class JdbcIngestionRepository implements IngestionRepository, CompressionRepository {
    ...
    private List<io.omnnu.finbot.application.ingestion.dto.ContentBlock> contentBlocks(String json) {
        try {
            return List.of(objectMapper.readValue(
                    json,
                    io.omnnu.finbot.application.ingestion.dto.ContentBlock[].class));
        } catch (JsonProcessingException exception) {
