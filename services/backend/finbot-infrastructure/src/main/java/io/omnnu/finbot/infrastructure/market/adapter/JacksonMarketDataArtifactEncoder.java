package io.omnnu.finbot.infrastructure.market.adapter;
...
public final class JacksonMarketDataArtifactEncoder implements MarketDataArtifactEncoder {
    ...
    public EncodedMarketDataArtifact encode(List<MarketInstrumentSeries> series) {
        ...
        var environments = series.stream()
                ...
                .map(io.omnnu.finbot.application.market.dto.MarketCandle::environment)
                .distinct()
                .toList();
        ...
        series.stream()
                ...
                .forEach(value -> {
                    ...
                    value.candles().stream()
                            .sorted(Comparator.comparing(io.omnnu.finbot.application.market.dto.MarketCandle::openTime))
