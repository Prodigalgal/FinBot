...
public class JdbcConfigurationRepository implements ConfigurationRepository {
    ...
    @Override
    @Transactional(readOnly = true)
    public Map<String, io.omnnu.finbot.application.configuration.AiProviderUsage> providerUsages() {
        return jdbcClient.sql("""
                ...
                .query((resultSet, rowNumber) -> Map.entry(
                        ...
                        new io.omnnu.finbot.application.configuration.AiProviderUsage(
