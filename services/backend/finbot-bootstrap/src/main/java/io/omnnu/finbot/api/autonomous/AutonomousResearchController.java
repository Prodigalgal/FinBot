package io.omnnu.finbot.api.autonomous;

import io.omnnu.finbot.api.operations.TaskResponse;
import io.omnnu.finbot.application.autonomous.AutonomousResearchStatus;
...
public final class AutonomousResearchController {
    ...
    public record StatusResponse(
            ...
            io.omnnu.finbot.application.operations.OperationsOverview.Schedule schedule,
            TaskResponse activeTask,
            io.omnnu.finbot.application.research.ResearchHistoryDetail.Summary latestRun,
