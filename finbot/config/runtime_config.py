...
CONFIG_FIELD_SPECS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec("firecrawl.proxy_ip_family", "Firecrawl", "代理 IP 类型", "select", "unknown", settings_field="firecrawl_proxy_ip_family", options=("unknown", "ipv4", "ipv6")),
    ConfigFieldSpec("firecrawl.proxy_dns_mode", "Firecrawl", "DNS 模式", "select", "local", settings_field="firecrawl_proxy_dns_mode", options=("local", "remote")),
    ...
    ConfigFieldSpec("firecrawl.vless_max_nodes", "Firecrawl", "VLESS 最大节点数", "integer", 1, settings_field="firecrawl_vless_max_nodes", minimum=0, maximum=50),
    ...
    ConfigFieldSpec("exchange.proxy_ip_family", "交易所代理", "代理 IP 类型", "select", "ipv6", settings_field="exchange_proxy_ip_family", options=("ipv4", "ipv6")),
